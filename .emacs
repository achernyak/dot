...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-bullets try which-key org-jekyll org-journal paredit-everywhere paredit helm-ispell latex-extra slime-company slime helm-projectile helm-company helm company markdown-preview-mode markdown-mode+ markdown-mode edit-server use-package))))
(custom-set-faces
